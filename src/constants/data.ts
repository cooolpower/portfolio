  ...
  careers: [
    {
      ...
      achievements: [
        ...
        "[플랫폼 레벨 기여] **레거시 코드 구조 개선 및 성능 최적화**",
        "[잡코리아 대규모 리뉴얼] **핵심 도메인 대규모 리뉴얼 프로젝트** 참여 (퍼블리싱 및 UI 구조 개선)",
        "[잡코리아 대규모 리뉴얼] **레거시 jQuery 기반 코드 유지보수** 및 점진적 구조 개선",
        "[잡코리아 대규모 리뉴얼] **주요 화면 마크업 구조 정비 및 반응형 대응**",
        "[잡코리아 대규모 리뉴얼] **Lighthouse 성능 개선 작업** 참여",
        "[AI 채팅] **WebSocket 기반 AI 채팅 UI 아키텍처 설계 및 구현** (메시지 상태 관리 및 실시간 동기화 처리)",
        "[AI 채팅] **WebSocket 단절 대비 자동 재연결 및 지수 백오프 적용**",
        "[AI 채팅] **낙관적 업데이트 기반 메시지 처리**",
        "[AI 채팅] **모바일 슬립 상태 복구 로직 설계**",
    ...
    },
    {
      ...
      achievements: [
        ...
        "[알바몬] **레거시 코드 구조 개선 및 유지보수**",
        "[알바몬] **웹 서비스 리뉴얼 및 UI 개선**",
  ...
  careers: [
    {
      ...
      achievements: [
        ...
        "[Platform-Level Contribution] **Refactored legacy code structure and optimized rendering performance**",
        "[JobKorea Major Renewal] **Participated in the large-scale service renewal for JobKorea** (Main, Search, Resume, Postings, and Login UI/Markup)",
        "[JobKorea Major Renewal] **Maintained legacy jQuery codebases and performed incremental refactoring**",
        "[JobKorea Major Renewal] **Standardized markup structures and applied responsive designs for core layouts**",
        "[JobKorea Major Renewal] **Contributed to Lighthouse performance tuning** to optimize initial mobile and desktop load speed metrics",
        "[AI Chatting] **Designed and implemented live WebSocket messaging UI architectures** (message state management and sync)",
        "[AI Chatting] **Implemented socket reconnection handlers backing STOMP channels with exponential backoff**",
        "[AI Chatting] **Applied UI optimistic updates for instant messaging feedback**",
        "[AI Chatting] **Designed offline recovery logic handling mobile sleep states**",
    ...
    },
    {
      ...
      achievements: [
        ...
        "[Albamon] **Refactored legacy codebases and conducted layout maintenance**",
        "[Albamon] **Participated in service renewals and UI enhancements**",
