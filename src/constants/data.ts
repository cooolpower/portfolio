  ...
  careers: [
    {
      ...
      achievements: [
        "공통 헤더 컴포넌트 설계 및 개발을 통한 팀 내 협업 컴포넌트 표준화",
        ...
        "Lighthouse 성능 개선 작업을 통한 모바일 및 데스크톱 진입 초기 지표 최적화",
      ],
  ...
  projects: [
    {
      ...
      summary: "외부 파트너사인 토스와의 데이터 연동을 위한 Open API 서버리스 인프라 구축 프로젝트입니다. 내부 데이터를 외부 스펙에 맞게 가공·전달하는 API 구조를 설계하고 인증 및 예외 처리 체계를 구축했습니다.",
      troubleshooting: [
        {
    ...
    },
    {
      ...
      summary: "채용 플랫폼 내 구직자와 기업 사용자를 연결하는 실시간 채팅 및 AI 챗봇 서비스를 개발했습니다. 실시간 메시징 환경에서 안정적인 상태 동기화와 장애 복원 UX를 구현하는 데 집중했습니다.",
      troubleshooting: [
        {
